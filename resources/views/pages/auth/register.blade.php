            ...
            <div class="d-flex flex-lg-row-fluid">
                <div class="d-flex flex-column flex-center pb-0 pb-lg-10 p-10 w-100">
                    <img class="theme-light-show mx-auto mw-100 w-150px w-lg-300px mb-10 mb-lg-20"
                        src="{{ asset('assets/media/logos/aalogo.png') }}" alt="" />
                    ...
                    <div class="text-gray-600 fs-base text-center fw-semibold">It all starts here.
                        <a href="#" class="opacity-75-hover text-primary me-1">23 years ago,</a> a dream took
                        flight - shaping and forever changing the travel industry in Asia
                        <br />The idea was simple: Make flying affordable for everyone.
                        <a href="#" class="opacity-75-hover text-primary me-1">We started an airline in
                            2001</a>Today
                        <br />we’ve evolved to become something much bigger. We’re now a world-class brand,
                        <br />a leading Asean airline, a digital travel and lifestyle platform; and we’re not stopping.
                    </div>
                </div>
            </div>
